                    ...
                    {hadith.grades && hadith.grades.length > 0 && (
                        <div className="mt-6 pt-4 border-t border-gray-100 dark:border-gray-800 flex flex-wrap gap-2 justify-end">
                            {hadith.grades.map((g, i) => (
                                <span key={i} className={`px-3 py-1 rounded-lg text-xs font-bold uppercase ${g.grade.toLowerCase().includes('sahih') ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' :
